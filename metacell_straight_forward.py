...
#path to the single cell to apply metacell (already had QC)
single_cell_path = "/mnt/scratch1/Fcarcanholo/cellxgene_python/xenium_breast_segger/sc_BRCA_subtype/sc_BRCA_atlas_adata.h5ad"
#path to store metacell outputs (it will be metacell, single cell with metacell annotation, most_cell_type csv)
metacell_output_path = "/mnt/scratch1/Fcarcanholo/Clean_pipelines/play_storage/metacell/"
name_column_cell_type = "celltype_major"
